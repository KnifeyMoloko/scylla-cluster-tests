...
class VirtualMachineProvider:
    def __init__(self, region: str, disk_struct_provider: DiskStructProvider, metadata_provider: MetadataProvider):
        self._region = region
    ...
    def get_or_create_instance(self,
        ...
        instance_params = {
            ...
            "ex_network": params.get("gce_network"),  # TODO: replace with self.params
            "ex_disks_gce_struct": self._disk_struct_provider.get_disks_struct(disk_struct_args),
            "ex_metadata": self._metadata_provider.get_ex_metadata(metadata_args),
