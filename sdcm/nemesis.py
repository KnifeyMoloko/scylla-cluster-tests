...
class DecommissionNotStopped(Exception):
    """
    Raised when we try to stop a decommission action and fail to do so.
    """
    ...
...
class Nemesis:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def _call_disrupt_func_after_expression_logged(self,
        ...
        will call the callable <func> with <func_kwargs> keyword
    ...
    def start_and_interrupt_decommission_streaming(self):
        ...
        def decommission_post_action():
            ...
            raise DecommissionNotStopped("Stopping the decommission was not successfull. "
                                         "New node was added in place of the decommissioned one."
                                         f"New node: {new_node.name}")
        ...
        watcher = partial(
            ...
            func=self.target_node.reboot,
            func_kwargs={"hard": True, "verify_ssh": True},
            delay=0
        )
    ...
    def start_and_interrupt_repair_streaming(self):
        ...
        3. Stop it with a hard reboot once the unbootstrapping starts.
        4. Verify that the node was not decommissioned completely or
        add a new node in its place in case it was.
        """
        self._destroy_data_and_restart_scylla()
    ...
    def start_and_interrupt_rebuild_streaming(self):
        ...
        ParallelObject(objects=[trigger, watcher], timeout=1800).call_objects()
        self.target_node.run_nodetool("rebuild")
